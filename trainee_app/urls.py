...
# from .views import TraineeListView, TraineeListCreateAPIView, TraineeUpdateDeleteAPIView, track_update, TraineeViewSet
from .views import TraineeListView, TraineeDeleteView, AddTraineeView, UpdateTraineeView
